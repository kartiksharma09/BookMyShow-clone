...
const Tickets = ({ bookTickets, Movie}) =>{
    ...
    console.log(typeof(bookTickets))
                                        ...
                                        <div className="col">
                                            {
                                                <div className="seat-plane">
                                                    <div class="ticket-box">
                                                        ...
                                                        <form className="Book-tiecket-form" onSubmit={(e) => SubmitDetails(e)}>
                                                            <div class="user-box">
                                                                <input type="text" name="name"  onChange={(e) => PassengerName(e)} required/>
                                                                <label> Name </label>

                                                            </div>
                                                            <div class="user-box">
                                                                <input type="text" name="age"  onChange={(e) => PassengerAge(e)} required/>
                                                                <label> Age </label>
                                                            </div>
                                                            <div className="form-check form-check-inline">
                                                                <input type="radio" name="gender" id="male"  onChange={(e) => Gender(e)} required/>
                                                                <label> Male </label>
                                                            </div>
                                                            <div className="form-check form-check-inline">
                                                                <input type="radio" name="gender" id="female" onChange={(e) => Gender(e)}  required/>
                                                                <label> Female </label>
                                                            </div>

                                                            <div className="user-box">
                                                                <input type="date" id="bookingDate" name="bookingDate"  onChange={(e) => BookingDate(e)} required/>
                                                                <label> Booking Date </label>
                                                            </div>
                                                            <div className="text-center">
                                                                <button className="btn btn-primary mt-3" type="submit">Book tickets</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
